...
const HEADER = "abcdefghijklmnopqrstuvwxyz";
...
export function intToKey(x) {
  const base = intToBase(x, BASE_62_DIGITS);
  return HEADER.getCharAt(base.length - 1) + base;
}

function intToBase(x, baseDigits) {
  let base = baseDigits.length;
  let result = '';
